 ...
 */
public class ConPacienteFragment extends Fragment  implements Response.ErrorListener, Response.Listener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        this.view = inflater.inflate(R.layout.fragment_con_paciente_list, container, false);
...
//incluindo objeto no array de envio
        jsonArray.put(paciente.toJsonObject());
...
*/
                if (view instanceof RecyclerView) {
                    ...
                    recyclerView.setAdapter(
                            new PacienteRecyclerViewAdapter(this.pacientes));
                }
            }else {
                Snackbar mensagem = Snackbar.make(view,
